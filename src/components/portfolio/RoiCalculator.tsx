...
export function RoiCalculator() {
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-neutral-300 bg-surface-inverted p-6 sm:p-10 shadow-sm grid lg:grid-cols-2 gap-10 text-text-inverted-primary">
        {/* Left Column: Input Sliders */}
        <div className="space-y-6">
          <div className="flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-neutral-950 font-bold border-b border-neutral-300/80 pb-3">
          ...
          <div className="rounded-xl border border-neutral-300 bg-neutral-50/80 p-4 space-y-3">
            ...
            <input
              ...
              className="w-full accent-brand-600 bg-neutral-200 rounded-lg h-3 cursor-pointer touch-target focus-ring"
            />
            <div className="flex justify-between text-[10px] font-mono text-neutral-600 font-medium">
              <span>5 hrs</span>
              <span>25 hrs</span>
              <span>50 hrs</span>
            </div>
        ...
        <div className="rounded-xl border border-border-default bg-surface-raised text-text-primary p-6 sm:p-8 flex flex-col justify-between">
          <div>
            <div className="font-mono text-[11px] uppercase tracking-widest text-action-primary font-semibold border-b border-border-subtle pb-3 mb-6 flex items-center justify-between">
              <span>[ PROJECTED_SAVINGS_METRICS ]</span>
              <span className="text-text-muted font-normal">CALCULATED LIVE</span>
            </div>

            <div className="grid sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-border-subtle bg-surface-base/80 p-4">
                <div className="text-xs text-text-muted font-mono">WEEKLY TIME RECLAIMED</div>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface-base/80 p-4">
                <div className="text-xs text-text-muted font-mono">MONTHLY HOURS SAVED</div>
                <div className="text-2xl font-mono font-bold text-text-primary mt-1 tabular-nums">
              ...
              <div className="rounded-xl border border-border-subtle bg-surface-base/80 p-4">
                <div className="text-xs text-text-muted font-mono">MONTHLY VALUE</div>
                <div className="text-2xl font-mono font-bold text-action-primary mt-1 tabular-nums">
          ...
          <div className="mt-8 pt-6 border-t border-border-subtle">
            <a
              href="#contact"
              className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-action-primary px-6 py-3.5 min-h-[44px] font-mono text-xs uppercase tracking-widest font-semibold text-action-primary-foreground hover:bg-action-primary-hover active:scale-[0.98] transition-all focus-ring"
            >
